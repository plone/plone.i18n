...
#
# 'langcode-variation' : {u'native' : 'Native name', u'name' : 'English name', u'flag' : u'/@@/country-flags/*.gif'}

_languagelist = {
u'aa' : {u'native' : 'магIарул мацI', u'name' : 'Afar', u'flag' : u'/@@/country-flags/dj.gif'},
u'ab' : {u'native' : 'бызшәа', u'name' : 'Abkhazian', u'flag' : u'/@@/country-flags/ge.gif'},
u'af' : {u'native' : 'Afrikaans', u'name' : 'Afrikaans'},
u'am' : {u'native' : 'አማርኛ', u'name' : 'Amharic'},
u'ar' : {u'native' : 'العربية', u'name' : 'Arabic'},
u'as' : {u'native' : 'অসমিয়া', u'name' : 'Assamese'},
u'ay' : {u'native' : 'Aymara', u'name' : 'Aymara'},
u'az' : {u'native' : 'Azəri Türkçəsi', u'name' : 'Azerbaijani', u'flag' : u'/@@/country-flags/az.gif'},
u'ba' : {u'native' : 'Bashkir', u'name' : 'Bashkir'},
u'be' : {u'native' : 'Беларускі', u'name' : 'Belarussian', u'flag' : u'/@@/country-flags/by.gif'},
u'bg' : {u'native' : 'Български', u'name' : 'Bulgarian', u'flag' : u'/@@/country-flags/bg.gif'},
...
u'bs' : {u'native' : 'Bosanski', u'name' : 'Bosnian', u'flag' : u'/@@/country-flags/ba.gif'},
u'br' : {u'native' : 'Brezhoneg', u'name' : 'Breton'},
u'ca' : {u'native' : 'Català', u'name' : 'Catalan'},
u'co' : {u'native' : 'Corsu', u'name' : 'Corsican'},
u'cs' : {u'native' : 'Čeština', u'name' : 'Czech', u'flag' : u'/@@/country-flags/cz.gif'},
u'cy' : {u'native' : 'Cymraeg', u'name' : 'Welsh', u'flag' : '/@@/language-flags/cy.gif'},
u'da' : {u'native' : 'Dansk', u'name' : 'Danish', u'flag' : u'/@@/country-flags/dk.gif'},
u'de' : {u'native' : 'Deutsch', u'name' : 'German', u'flag' : u'/@@/country-flags/de.gif'},
u'dz' : {u'native' : 'Bhutani', u'name' : 'Indian Bhutani'},
u'el' : {u'native' : 'Ελληνικά', u'name' : 'Greek', u'flag' : u'/@@/country-flags/gr.gif'},
u'en' : {u'native' : 'English', u'name' : 'English', u'flag' : u'/@@/country-flags/gb.gif'},
u'eo' : {u'native' : 'Esperanto', u'name' : 'Esperanto', u'flag' : '/@@/language-flags/eo.gif'},
u'es' : {u'native' : 'Español', u'name' : 'Spanish', u'flag' : u'/@@/country-flags/es.gif'},
u'et' : {u'native' : 'Eesti', u'name' : 'Estonian', u'flag' : u'/@@/country-flags/ee.gif'},
u'eu' : {u'native' : 'Euskara', u'name' : 'Basque', u'flag' : '/@@/language-flags/eu.gif'},
u'fa' : {u'native' : 'فارسی', u'name' : 'Persian'},
u'fi' : {u'native' : 'Suomi', u'name' : 'Finnish', u'flag' : u'/@@/country-flags/fi.gif'},
u'fj' : {u'native' : 'Fiji', u'name' : 'Fiji', u'flag' : u'/@@/country-flags/fj.gif'},
u'fo' : {u'native' : 'Føroyska', u'name' : 'Faroese'},
u'fr' : {u'native' : 'Français', u'name' : 'French', u'flag' : u'/@@/country-flags/fr.gif'},
...
u'he' : {u'native' : 'עברית', u'name' : 'Hebrew', u'flag' : u'/@@/country-flags/il.gif'},
u'hi' : {u'native' : 'हिंदी', u'name' : 'Hindi', u'flag' : u'/@@/country-flags/in.gif'},
u'hr' : {u'native' : 'Hrvatski', u'name' : 'Croatian', u'flag' : u'/@@/country-flags/hr.gif'},
u'hu' : {u'native' : 'Magyar', u'name' : 'Hungarian', u'flag' : u'/@@/country-flags/hu.gif'},
u'hy' : {u'native' : 'Հայերէն', u'name' : 'Armenian', u'flag' : u'/@@/country-flags/am.gif'},
u'ia' : {u'native' : 'Interlingua', u'name' : 'Interlingua'},
u'id' : {u'native' : 'Bahasa Indonesia', u'name' : 'Indonesian', u'flag' : u'/@@/country-flags/id.gif'},
u'ie' : {u'native' : 'Interlingue', u'name' : 'Interlingue'},
u'ik' : {u'native' : 'Inupiak', u'name' : 'Inupiak'},
u'is' : {u'native' : 'Íslenska', u'name' : 'Icelandic', u'flag' : u'/@@/country-flags/is.gif'},
u'it' : {u'native' : 'Italiano', u'name' : 'Italian', u'flag' : u'/@@/country-flags/it.gif'},
u'iu' : {u'native' : 'ᐃᓄᒃᑎᑐᑦ', u'name' : 'Inuktitut'},
u'ja' : {u'native' : '日本語', u'name' : 'Japanese', u'flag' : u'/@@/country-flags/jp.gif'},
u'jw' : {u'native' : 'Javanese', u'name' : 'Javanese'},
u'ka' : {u'native' : 'ქართული', u'name' : 'Georgian', u'flag' : u'/@@/country-flags/ge.gif'},
u'kk' : {u'native' : 'ﻗﺎﺯﺍﻗﺸﺎ', u'name' : 'Kazakh', u'flag' : u'/@@/country-flags/kz.gif'},
u'kl' : {u'native' : 'Greenlandic', u'name' : 'Greenlandic', u'flag' : u'/@@/country-flags/gl.gif'},
u'km' : {u'native' : 'ខ្មែរ', u'name' : 'Cambodian/Khmer', u'flag' : u'/@@/country-flags/kh.gif'},
u'kn' : {u'native' : 'ಕನ್ನಡ', u'name' : 'Kannada', u'flag' : u'/@@/country-flags/in.gif'},
u'ko' : {u'native' : '한국어', u'name' : 'Korean', u'flag' : u'/@@/country-flags/kr.gif'},
u'ks' : {u'native' : 'काऽशुर', u'name' : 'Kashmiri', u'flag' : u'/@@/country-flags/in.gif'},
u'ku' : {u'native' : 'Kurdí', u'name' : 'Kurdish'},
u'kw' : {u'native' : 'Kernewek', u'name' : 'Cornish'},
u'ky' : {u'native' : 'Кыргыз', u'name' : 'Kirghiz'},
u'la' : {u'native' : 'Latin', u'name' : 'Latin', u'flag' : u'/@@/country-flags/va.gif'},
u'lb' : {u'native' : 'Lëtzebuergesch', u'name' : 'Luxemburgish', u'flag' : u'/@@/country-flags/lu.gif'},
u'li' : {u'native' : 'Limburgs', u'name' : 'Limburgish'},
u'ln' : {u'native' : 'Lingala', u'name' : 'Lingala'},
u'lo' : {u'native' : 'ພາສາລາວ', u'name' : 'Laotian', u'flag' : u'/@@/country-flags/la.gif'},
u'lt' : {u'native' : 'Lietuviskai', u'name' : 'Lithuanian', u'flag' : u'/@@/country-flags/lt.gif'},
u'lv' : {u'native' : 'Latviešu', u'name' : 'Latvian'},
u'mg' : {u'native' : 'Malagasy', u'name' : 'Madagascarian', u'flag' : u'/@@/country-flags/mg.gif'},
u'mi' : {u'native' : 'Maori', u'name' : 'Maori'},
u'mk' : {u'native' : 'Македонски', u'name' : 'Macedonian', u'flag' : u'/@@/country-flags/mk.gif'},
u'ml' : {u'native' : 'മലയാളം', u'name' : 'Malayalam'},
u'mn' : {u'native' : 'Монгол', u'name' : 'Mongolian', u'flag' : u'/@@/country-flags/mn.gif'},
u'mo' : {u'native' : 'Moldavian', u'name' : 'Moldavian', u'flag' : u'/@@/country-flags/md.gif'},
u'mr' : {u'native' : 'मराठी', u'name' : 'Marathi'},
u'ms' : {u'native' : 'Bahasa Melayu', u'name' : 'Malay'},
u'mt' : {u'native' : 'Malti', u'name' : 'Maltese', u'flag' : u'/@@/country-flags/mt.gif'},
u'my' : {u'native' : 'Burmese', u'name' : 'Burmese'},
u'na' : {u'native' : 'Nauru', u'name' : 'Nauruan', u'flag' : u'/@@/country-flags/nr.gif'},
u'ne' : {u'native' : 'नेपाली', u'name' : 'Nepali'},
u'nl' : {u'native' : 'Nederlands', u'name' : 'Dutch', u'flag' : u'/@@/country-flags/nl.gif'},
u'no' : {u'native' : 'Norsk', u'name' : 'Norwegian', u'flag' : u'/@@/country-flags/no.gif'},
u'nn' : {u'native' : 'Nynorsk', u'name' : 'Norwegian Nynorsk', u'flag' : u'/@@/country-flags/no.gif'},
...
u'pl' : {u'native' : 'Polski', u'name' : 'Polish', u'flag' : u'/@@/country-flags/pl.gif'},
...
u'sd' : {u'native' : 'Sindhi', u'name' : 'Sindhi', u'flag' : u'/@@/country-flags/pk.gif'},
u'se' : {u'native' : 'Northern Sámi', u'name' : 'Northern Sámi'},
u'sg' : {u'native' : 'Sangho', u'name' : 'Sangho', u'flag' : u'/@@/country-flags/cf.gif'},
u'sh' : {u'native' : 'Serbo-Croatian', u'name' : 'Serbo-Croatian'},
u'si' : {u'native' : 'Singhalese', u'name' : 'Singhalese'},
u'sk' : {u'native' : 'Slovenčina', u'name' : 'Slovak', u'flag' : u'/@@/country-flags/sk.gif'},
u'sl' : {u'native' : 'Slovenščina', u'name' : 'Slovenian', u'flag' : u'/@@/country-flags/si.gif'},
u'sm' : {u'native' : 'Samoan', u'name' : 'Samoan'},
u'sn' : {u'native' : 'Shona', u'name' : 'Shona'},
u'so' : {u'native' : 'Somali', u'name' : 'Somali', u'flag' : u'/@@/country-flags/so.gif'},
u'sq' : {u'native' : 'Shqip', u'name' : 'Albanian', u'flag' : u'/@@/country-flags/al.gif'},
u'sr' : {u'native' : 'српски', u'name' : 'Serbian', u'flag' : u'/@@/country-flags/cs.gif'},
u'ss' : {u'native' : 'Siswati', u'name' : 'Siswati'},
u'st' : {u'native' : 'Sesotho', u'name' : 'Sesotho'},
u'su' : {u'native' : 'Sudanese', u'name' : 'Sudanese', u'flag' : u'/@@/country-flags/sd.gif'},
u'sv' : {u'native' : 'Svenska', u'name' : 'Swedish', u'flag' : u'/@@/country-flags/se.gif'},
u'sw' : {u'native' : 'Swahili', u'name' : 'Swahili'},
u'ta' : {u'native' : 'தமிழ', u'name' : 'Tamil'},
u'te' : {u'native' : 'తెలుగు', u'name' : 'Telugu'},
u'tg' : {u'native' : 'Тоҷики', u'name' : 'Tadjik', u'flag' : u'/@@/country-flags/tj.gif'},
u'th' : {u'native' : 'ไทย', u'name' : 'Thai', u'flag' : u'/@@/country-flags/th.gif'},
u'ti' : {u'native' : 'ትግርኛ', u'name' : 'Tigrinya'},
u'tk' : {u'native' : 'түркmенче', u'name' : 'Turkmen', u'flag' : u'/@@/country-flags/tm.gif'},
u'tl' : {u'native' : 'Tagalog', u'name' : 'Tagalog'},
u'tn' : {u'native' : 'Setswana', u'name' : 'Setswana', u'flag' : u'/@@/country-flags/bw.gif'},
u'to' : {u'native' : 'Tonga', u'name' : 'Tonga'},
u'tr' : {u'native' : 'Türkçe', u'name' : 'Turkish', u'flag' : u'/@@/country-flags/tr.gif'},
...
u'uk' : {u'native' : 'Українська', u'name' : 'Ukrainian', u'flag' : u'/@@/country-flags/ua.gif'},
u'ur' : {u'native' : 'اردو', u'name' : 'Urdu'},
u'uz' : {u'native' : 'Ўзбекча', u'name' : 'Uzbek', u'flag' : u'/@@/country-flags/uz.gif'},
u'vi' : {u'native' : 'Tiếng Việt', u'name' : 'Vietnamese', u'flag' : u'/@@/country-flags/vn.gif'},
...
u'yi' : {u'native' : 'ײִדיש', u'name' : 'Yiddish', u'flag' : u'/@@/country-flags/il.gif'},
u'yo' : {u'native' : 'Yorùbá', u'name' : 'Yorouba'},
u'za' : {u'native' : 'Zhuang', u'name' : 'Zhuang'},
u'zh' : {u'native' : '中文', u'name' : 'Chinese', u'flag' : u'/@@/country-flags/cn.gif'},
...
u'ar-ae' : {u'name' : 'Arabic (United Arab Emirates)'},
u'ar-bh' : {u'name' : 'Arabic (Bahrain)'},
u'ar-dz' : {u'name' : 'Arabic (Algeria)'},
u'ar-eg' : {u'name' : 'Arabic (Egypt)'},
u'ar-il' : {u'name' : 'Arabic (Israel)'},
u'ar-iq' : {u'name' : 'Arabic (Iraq)'},
u'ar-jo' : {u'name' : 'Arabic (Jordan)'},
u'ar-kw' : {u'name' : 'Arabic (Kuwait)'},
u'ar-lb' : {u'name' : 'Arabic (Lebanon)'},
u'ar-ly' : {u'name' : 'Arabic (Libya)'},
u'ar-ma' : {u'name' : 'Arabic (Morocco)'},
u'ar-mr' : {u'name' : 'Arabic (Mauritania)'},
u'ar-om' : {u'name' : 'Arabic (Oman)'},
u'ar-ps' : {u'name' : 'Arabic (Palestinian West Bank and Gaza)'},
u'ar-qa' : {u'name' : 'Arabic (Qatar)'},
u'ar-sa' : {u'name' : 'Arabic (Saudi Arabia)'},
u'ar-sd' : {u'name' : 'Arabic (Sudan)'},
u'ar-so' : {u'name' : 'Arabic (Somalia)'},
u'ar-sy' : {u'name' : 'Arabic (Syria)'},
u'ar-td' : {u'name' : 'Arabic (Chad)'},
u'ar-tn' : {u'name' : 'Arabic (Tunisia)'},
u'ar-ye' : {u'name' : 'Arabic (Yemen)'},
...
u'de-at' : {u'name' : 'German (Austria)', u'native' : 'Deutsch (Österreich)',  u'flag' : u'/@@/country-flags/at.gif'},
u'de-be' : {u'name' : 'German (Belgium)'},
u'de-ch' : {u'name' : 'German (Switzerland)', u'flag' : u'/@@/country-flags/ch.gif'},
u'de-de' : {u'name' : 'German (Germany)', u'flag' : u'/@@/country-flags/de.gif'},
...
u'pt-br' : {u'name' : 'Brazilian Portuguese', u'native'  : 'Português (Brasil)', u'flag' : u'/@@/country-flags/br.gif'},
...
u'zh-cn' : {u'name' : 'Chinese (China)', u'native' : '简体中文(中国)',  u'flag' : u'/@@/country-flags/cn.gif'},
u'zh-hk' : {u'name' : 'Chinese (Hongkong)', u'native' : '繁體中文(香港)',  u'flag' : u'/@@/country-flags/hk.gif'},
u'zh-sg' : {u'name' : 'Chinese (Singapore)', u'native' : '简体中文(新加坡)',  u'flag' : u'/@@/country-flags/sg.gif'},
u'zh-tw' : {u'name' : 'Chinese (Taiwan)', u'native' : '繁體中文(臺灣)',  u'flag' : u'/@@/country-flags/tw.gif'}
}
